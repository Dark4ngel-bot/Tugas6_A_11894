...
model = load_model(r'D:\File Dylan 3\mlend\Tugas6_A_11894\model_mobilenet.h5')
...
st.title("Prediksi Kematangan Buah Naga - 1894")
...
if st.sidebar.button("Prediksi"):
    if uploaded_files:
        ...
        # Perform prediction
        label, confidence = classify_images(uploaded_file.name)
